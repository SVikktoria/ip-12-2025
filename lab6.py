...
def logged(exception, mode="console"):
    """
    Декоратор для логування винятів
    :param exception: тип винятку для логшування
...
class XMLFileManager:
    """ 
    Клас для керування XML файлами 
    """
    ...
    def read(self):
        """
        Читання XML та повернення списку рядків <line>.
        """
        try:
    ...
    def write(self, data: str):
        """
        Запис тексту у форматі XML, де кожен рядок стає <line>.
        """
        try:
    ...
    def append(self, data: str):
        """
        Дописує нові рядки у вже існуючий XML-файл.
        """
        try:
            try:
                tree = ET.parse(self.filepath)
    ...
    def get_root_tag(self):
        """Додатковий метод для отримання кореневого тегу"""
        try:
            tree = ET.parse(self.filepath)
